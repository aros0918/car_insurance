    ...
    <div style={{display: "flex", justifyContent: "center", alignItems: "center"}}>
      ...
      >
        ...
        <p>
          ...
          govern The Fair Insurance’s relationship with you in relation to this website. The term ‘The Fair
          Insurance’ or ‘us’ or ‘we’ refers to the owner of the website whose registered office is 104 West 40th
          Street, 5th Floor New York, NY 10018, United States. The term ‘you’ refers to the user or viewer of our
          website. The use of this website is subject to the following terms of use:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            offered on this website for any particular purpose. You acknowledge that such information
          ...
          <li>
            You may not create a link to this website from another website or document without The Fair
            Insurance’s prior written consent
          </li>
          <li>
        ...
        <p>
          Any dispute or claim relating in any way to your use of this website, including any related calls texts or
          other communications, will be resolved by binding arbitration, rather than in court, except that you may
          ...
          and declaratory relief or statutory damages), and must follow the terms of these terms as a court would.
          The arbitration may be conducted by the American Arbitration Association (AAA) under its rules,
          including the AAA's Supplementary Procedures for Consumer-Related Disputes. The AAA's rules are
          available at www.adr.org or by calling 1-800-778-7879. You may choose to have the arbitration
          ...
          We each agree that any dispute resolution proceedings will be conducted only on an individual basis and
          not in a class, consolidated or representative action. If for any reason a claim proceeds in court rather than
